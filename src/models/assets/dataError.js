const errText = {
    ...
    childByIdNotExist: "ילד בעל קוד אישי {0} לא קיים במערכת.",
    ...
    statByChildIdNotExist: "סטטיסטיקה עבור הילד בעל הקוד האישי {0} לא קיימת במערכת.",
    childByIdAlreadyExist: "ילד בעל הקוד האישי {0} כבר קיים במערכת.",

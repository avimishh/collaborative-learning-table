...
router.post('/', async (req, res) => {
    ...
    let teacher_id = await (await Teacher.findOne({id:req.body.teacher}))._id;
    // Create new document
    ...
    try {
        let child = await Child.findOneAndUpdate({id:req.body.child},
        {
            $push: { notes: newNote }
        }, {
